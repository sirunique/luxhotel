...
?>
      ...
      <aside class="app-sidebar">
        ...
        <ul class="app-menu">
          ...
          <li><a class="app-menu__item active" href="payment.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Payment</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Payment</h1>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
                ...
                <a class="btn btn-primary" href="payment.php">Refresh</a>
                ...
                <div class="table-responsive">
                    ...
                    <tr>
                    <?php
                      $selectdata = Payment::find_all();
                      $countdata = Payment::count_all();
                      for($i=1; $i <= $countdata ; $i++) 
                      { 
                        $fetchdata = Payment::fetch_array($selectdata);
                    ...
                    ?>
                      ...
                      <td><?php echo $fetchdata['ref_code'];  ?></td>
                      <td><?php echo $fetchdata['payment_type'];  ?></td>
